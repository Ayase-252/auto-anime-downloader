...
def download(uri, name, ep, translation_team='', save_path='', **kargs):
    """
    ...
    """
    print('Downloading {} {} from {}'.format(name, ep, uri))
    user_agent = {
        'User-agent': 'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML,'
                      'like Gecko) Chrome/41.0.2228.0 Safari/537.36'
    }
    response = requests.get(uri, headers=user_agent, timeout=5)
